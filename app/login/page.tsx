    ...
    <div className="min-h-screen bg-gradient-to-br from-[#004953] via-[#014852] to-[#003a44] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-[70px] h-[70px] bg-white rounded-2xl mb-4 shadow-lg">
            <span className="font-black text-3xl text-[#004953]">TMS</span>
          </div>
          <h1 className="text-3xl font-bold text-white mb-2">
            Tyre Management System
          </h1>
          <p className="text-white/80 text-lg">FleetCo Submodule</p>
        </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input
                  type="checkbox"
                  className="h-4 w-4 text-[#004953] focus:ring-[#004953] border-gray-300 rounded"
                />
                <span className="ml-2 text-sm text-gray-700">Remember me</span>
              </label>
              <Link
                href="/resetPassword"
                className="text-sm text-[#004953] hover:text-[#014852] font-medium transition-colors"
              >
                Forgot password?
              </Link>
            </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-white/60 text-sm">
            © {new Date().getFullYear()} TMS (FleetCo). All rights reserved.
          </p>
        </div>
      </div>
    </div>
